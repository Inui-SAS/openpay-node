...
function Customers(baseData) {
    ...
    this.subscriptions = {
        ...
        create: function (customerId, data, callback) {
            sendRequest(_.extend(baseData, {
                apiUrl: baseData.merchantId + '/customers/' + customerId + '/subscriptions',
                requestData: {method: 'POST', json: data},
                callback: callback
            }));
        },
    ...
    this.checkouts = {
        ...
        create: function (customerId, data, callback) {
            sendRequest(_.extend(baseData, {
                apiUrl: baseUrl + '/' + customerId + '/checkouts',
                requestData: {method: 'POST', json: data},
                callback: callback
            }));
        }
...
function Groups(baseData) {
    ...
    this.customers = {
        ...
        charges: {
            ...
            create: function (merchantId, customerId, data, callback) {
                sendRequest(_.extend(baseData, {
                    apiUrl: baseUrl + merchantId + '/customers/' + customerId + '/charges',
                    requestData: {method: 'POST', json: data},
                    callback: callback
                }));
            },
            ...
            capture: function (merchantId, customerId, transactionId, data, callback) {
                sendRequest(_.extend(baseData, {
                    apiUrl: baseUrl + merchantId + '/customers/' + customerId + '/charges/' + transactionId + '/capture',
                    requestData: {method: 'POST', json: data},
                    callback: callback
                }));
            },
            ...
            refund: function (merchantId, customerId, transactionId, data, callback) {
                sendRequest(_.extend(baseData, {
                    apiUrl: baseUrl + merchantId + '/customers/' + customerId + '/charges/' + transactionId + '/refund',
                    requestData: {method: 'POST', json: data},
                    callback: callback
                }));
            }
        ...
        subscriptions: {
            ...
            create: function (merchantId, customerId, data, callback) {
                sendRequest(_.extend(baseData, {
                    apiUrl: baseUrl + merchantId + '/customers/' + customerId + '/subscriptions',
                    requestData: {method: 'POST', json: data},
                    callback: callback
                }));
            },
            ...
            list: function (merchantId, customerId, data, callback) {
                ...
                var callback = _.isFunction(callback) ? callback : _.isFunction(data) ? data : null;
                sendRequest(_.extend(baseData, {
                    apiUrl: baseUrl + merchantId + '/customers/' + customerId + '/subscriptions' + query,
                    requestData: {method: 'GET'},
                    callback: callback
                }));
            },
            ...
            get: function (merchantId, customerId, subscriptionId, callback) {
                sendRequest(_.extend(baseData, {
                    apiUrl: baseUrl + merchantId + '/customers/' + customerId + '/subscriptions/' + subscriptionId,
                    requestData: {method: 'GET'},
                    callback: callback
                }));
            },
    ...
    this.charges = {
        ...
        create: function (merchantId, data, callback) {
            sendRequest(_.extend(baseData, {
                apiUrl: baseUrl + merchantId + '/charges',
                requestData: {method: 'POST', json: data},
                callback: callback
            }));
        },
        ...
        capture: function (merchantId, transactionId, data, callback) {
            sendRequest(_.extend(baseData, {
                apiUrl: baseUrl + merchantId + '/charges/' + transactionId + '/capture',
                requestData: {method: 'POST', json: data},
                callback: callback
            }));
        },
        ...
        refund: function (merchantId, transactionId, data, callback) {
            sendRequest(_.extend(baseData, {
                apiUrl: baseUrl + merchantId + '/charges/' + transactionId + '/refund',
                requestData: {method: 'POST', json: data},
                callback: callback
            }));
        }
